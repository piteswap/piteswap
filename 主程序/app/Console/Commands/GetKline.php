...
// 定义参数
defined('ACCOUNT_ID') or define('ACCOUNT_ID', '449302859'); // 你的账户ID
defined('ACCESS_KEY') or define('ACCESS_KEY', 'c4c66a26-12ef5bd0-08cebe3b-ed2htwf5tf'); // 你的ACCESS_KEY
defined('SECRET_KEY') or define('SECRET_KEY', 'c0972ddb-0caefbdd-713349ba-1d4b4'); // 你的SECRET_KEY
