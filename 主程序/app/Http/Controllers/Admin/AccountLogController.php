...
class AccountLogController extends Controller
{
    ...
    public function index()
    {
        //获取type类型
        $type = array(
            AccountLog::ADMIN_LEGAL_BALANCE => '系统调节法币账户余额',
            AccountLog::ADMIN_LOCK_LEGAL_BALANCE => '系统调节法币账户锁定余额',
            AccountLog::ADMIN_CHANGE_BALANCE => '系统调节币币账户余额',
            AccountLog::ADMIN_LOCK_CHANGE_BALANCE => '系统调节币币账户锁定余额',
            AccountLog::ADMIN_LEVER_BALANCE => '系统调节杠杆账户余额',
            AccountLog::ADMIN_LOCK_LEVER_BALANCE => '系统调节杠杆账户锁定余额',
            AccountLog::ADMIN_MICRO_BALANCE => '系统调节秒合约账户余额', //后台调节秒合约账户余额
            AccountLog::ADMIN_LOCK_MICRO_BALANCE => '系统调节秒合约账户锁定余额', //后台调节秒合约账户锁定余额
