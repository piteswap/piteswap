...
class NewsController extends Controller
{
    ...
    public function getCategory()
    {
      ...
      public function get_customer_url(){
        $set = Setting::getValueByKey('customer_url');
        $logo = Setting::getValueByKey('cover');
        $title = Setting::getValueByKey('title_Name');
        return $this->success(['customer_url'=>$set, 'cover' => $logo,'xtitle' => $title]);
    }
