...
@section('page-content')
    <form class="layui-form" action="" style="padding-bottom: 20px;">
               ...
               <table class="layui-table">
                <tbody>
                    ...
                    <tr>
                         <td >
                            出款类型：
                            @if($wallet_out->is_bank==0)
                                <span style="color: green;">提币</span>
                            @else
                                <span style="color: blue;">银行卡</span>
                            @endif
                           
                        </td>
                        @if($wallet_out->is_bank==1)
                        <td>
                            USDT汇率兑换后：{{$wallet_out->real_number*$USDTRate}} 
                        </td>
                        @endif
                    </tr>
                    ...
                    <tr>
                         <td colspan="2">
                            ...
                            @if($wallet_out->nettype)
                            (提币网络：{{$wallet_out->nettype}})
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                         <td colspan="2">
                            银行卡号：{{$wallet_out->bank_account}} 
                            
                        </td>
                    </tr>
                    <tr>
                         <td colspan="2">
                            银行姓名：{{$wallet_out->real_name}} 
