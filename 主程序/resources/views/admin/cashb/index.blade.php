...
@section('page-content')
    ...
    <script type="text/html" id="wdtype">
        @{{d.is_bank==0 ? '<span class="layui-badge layui-bg-green">'+'提币'+'</span>' : '' }}
        @{{d.is_bank==1 ? '<span class="layui-badge layui-bg-blue">'+'银行卡'+'</span>' : '' }}
        ...
        layui.use(['table','form'], function(){
            ...
            table.render({
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'is_bank', title: '出款类型',templet: '#wdtype'}
