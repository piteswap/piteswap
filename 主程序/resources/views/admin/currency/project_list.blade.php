            ...
            table.render({
                ...
                ,cols: [[ //表头
                    {field: 'id', title: 'ID', width:80, sort: true}
                     ...
                     ,{field: 'currency_name', title: '项目币种', width:100}
                     ,{field: 'pay_currency_name', title: '支付币种', width:100}
                    ,{field: 'title', title: '标题', width:100}
                    ,{field: 'summary', title: '摘要', width:100}
                    ,{field:'amount',title: '发行总量', width:100}
                    ,{field: 'price', title: 'U价格', width:100}
                     ,{field: 'btc_price', title: 'BTC价格', width:100}
                      ,{field: 'eth_price', title: 'ETH价格', width:100}
                    ,{field: 'start_at', title: '开始时间', width:150}
                    ,{field: 'end_at', title: '结束时间',width:150}
