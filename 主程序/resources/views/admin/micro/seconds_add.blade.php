...
@section('page-content')
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">下注限额</label>
            <div class="layui-input-block">
                <input type="text" name="min_num" lay-verify="required" autocomplete="off" placeholder="最低下注限额 填0则不限制" class="layui-input" value="{{$result->min_num}}">
            </div>
        </div>
