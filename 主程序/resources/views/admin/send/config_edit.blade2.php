...
@section('page-content')
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="currency_id" lay-verify="required" id="currency_id" value="{{$model->currency_name}}" lay-search>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <div class="layui-input-inline date_time111" style="margin-left: 50px;">
                    <input type="text" name="start_time" id="start_time" value="{{$model->send_start}}" placeholder="请输入开始时间" autocomplete="off" class="layui-input" value="">
                </div>
                <div class="layui-input-inline date_time111" style="margin-left: 25px;">
                    <input type="text" name="end_time" id="end_time" value="{{$model->send_end}}" placeholder="请输入结束时间" autocomplete="off" class="layui-input" value="">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="predict_rate" id="predict_rate" value="{{$model->predict_rate}}" required autocomplete="off" placeholder="" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
    ...
    <script>
        ...
        layui.use(['form','laydate'],function () {
            ...
            form.on('submit(demo1)', function(data){
                ...
                $.ajax({
                    url:'{{url('admin/send/edit_deposit_config')}}'
                    ,type:'post'
                    ,dataType:'json'
                    ,data : data
