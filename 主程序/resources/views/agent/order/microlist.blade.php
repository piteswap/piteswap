    ...
    <div class="layui-form layui-card-header layuiadmin-card-header-auto" lay-filter="layadmin-userfront-formlist">
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-inline" style="margin-left: 10px;">
            ...
            <div class="layui-input-inline" style=" width: 30px;margin: 0;position: relative;left: -10px;">
              <button class="layui-btn layui-btn-primary" id="btn-set" type="button" style="position: relative;display: block;padding: 0 5px;">
                <i class="layui-icon layui-icon-set-fill" style="right:0;position: relative;"></i>
              </button>
            </div>
          </div>
  ...
  layui.use(['index','table', 'layer', 'laydate', 'form'], function () {
    ...
    var data_table = table.render({
      ...
      , cols: [[
        ...
        , { field: 'user_id', title: '用户ID', width: 130, sort: true }
