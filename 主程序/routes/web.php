...
//<--LDH-->
    ...
    Route::post('api/user/sms_send', 'Api\LoginController@sms_send');//发送短信验证码
    Route::post('api/user/sms_mail', 'Api\LoginController@sms_mail');//发送邮箱验证码
...
//管理后台
    Route::group(['prefix' => 'admin', 'middleware' => ['admin_auth']], function () {
       ...
       // Route::any('ueditor/uploader', 'Admin\UeditorController@ueditor');
        ...
        Route::any('Leverdeals/list', 'Admin\TransactionController@Leverdeals');//合约交易 团队所有订单
        Route::get('Leverdeals/csv', 'Admin\TransactionController@csv');//导出合约交易 团队所有订单
