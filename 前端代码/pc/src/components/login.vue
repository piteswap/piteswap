  ...
  <div id="register-box" style="height: 100%">
    ...
    <div class="main-register">
      ...
      <div
        ...
        "
      >
        <div class="reg-content" style="width: auto">
          ...
          <div style="margin-top: 10px">
            ...
            <button class="register-button curPer" @click="login">
              {{ $t("header.in") }}
            </button>
            <div class="have-account" style="margin-left: 10px; width: 160px">
              <router-link
                tag="span"
                class="baseColor"
                to="/forgetPwd"
                style="cursor: pointer; color: #2ab098"
              >
                {{ $t("login.forget") }}
              </router-link>
            </div>
