export default {
  ...
  footer: {
    ...
    yinsi: '隱私條款',
    legal: '法律聲明',
    email_info: '官方郵箱：：masonmacy792@gmail.com',
    email_pre: '客服：',
    address: '新加坡© 2013-2020 YCoin',
    feilv: '交易費率',
    notice: '公告中心',
    nhelp: '新手幫助',
    support: '線上客服',
    ...
    coin: '數字資產介紹',
    service: '服务',
    apply_url: 'https://www.piaichat.com/dist/#/components/noticeDetail?id=198',
    ...
    yinsi_url: 'https://www.piaichat.com/dist/#/components/noticeDetail?id=219',
    feilv_url: 'https://www.piaichat.com/dist/#/components/noticeDetail?id=224',
    legal_url: 'https://www.piaichat.com/dist/#/components/noticeDetail?id=229'
  },
  home: {
    accountname: '用戶中心',
    TrendChart: '走勢圖',
    ...
    c9: '依托4年的數字資產安全風控經驗',
    c10: '安全穩定運營數字資產交易所超過四年',
    c11: '管理資產規模超過10億美金，服務數百萬用戶',
    c12: '專業分佈式架構和防DDOS攻擊系統',
    c13: '98%數字資產存儲多重簽名冷錢包',
    c14: '香港 首爾 新加坡 東京',
    c15: '遍布世界各地的服務中心',
    c16: '馬上交易',
    ...
    img2: '2_zh.png',
    img3: '3_zh.png',
    d1: 'YCoin 全球站，近24小時成交量<b>{number}</b>美元',
  ...
  account: {
    Screenshottransfer: '轉賬截圖',
    Rechargequantity: '充值數量',
    pquantity: '請輸入充值的數量',
    uploadimg: '只能上傳jpg/png文件，且不超過500kb',
    Submitn: '提交充值申請',
    upload: '點擊上傳',
  ...
  assets: {
    transfer_out: '轉出到幣幣賬戶',
    transfer_in: '從幣幣賬戶轉入',
    transfer_complete: '劃轉完成',
  },
  currency: {
    subscription: '新幣申購',
    mysubscription: '我的申購',
