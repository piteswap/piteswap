export default {
  ...
  footer: {
    ...
    email: '商务邮箱',
    email_pre: '客服：',
    email_info: '官方邮箱：masonmacy792@gmail.com',
    feedback: '问题反馈',
    address: '新加坡© 2013-2020 DEX',
    about2: '公司简介',
    service: '服务',
    coin: '数字资产介绍',
  ...
  home: {
    ...
    img2: '2_zh.png',
    img3: '3_zh.png',
    d1: 'DEX 全球站，近24小时成交量<b>{number}</b>美元',
  ...
  auth: {
    ...
    truenum: '请输入证件号',
    up: '提交',
    note: '请上传，第一张为身份证正面，第二张为身份证反面，第三张为手持身份证照片。',
	authts:'请先实名认证',
	xinxits:'请填写完整信息'
  },
  auth2: {
    ...
    back: '证件照背面',
    hand: '上传手持证件照',
    tip2: '请提供一张您手持证件照的照片，在同张照片中也要包含有“DEX”、日期和您的签名的注释。请确保您的脸部清晰可见，且所有证件详细信息都清楚可读',
    face: '面部清晰可见无遮挡',
    clearly: '照片清晰可见',
    notes: '带有[DEX]的文字注释',
    ...
    tip4: ' 请提供一张您本人的DEX账号的资产明细截图或者照片，图片中包含您的账户名、uid、持仓详情、当前时间。所有信息清晰可读。',
    screenshot: '上传资产截图信息',
    nowLever: '当前认证等级',
    authCard: '身份证',
    authcardid: '请输入身份证号',
  ...
  account: {
    Screenshottransfer: '转账截图',
    Rechargequantity: '充值数量',
    pquantity: '请输入充值的数量',
    uploadimg: '只能上传jpg/png文件，且不超过500kb',
    Submitn: '提交充值申请',
    upload: '点击上传',
    mult100: '数量应为100的整数倍',
    exchange: '兑换',
  ...
  tpc: {
    ...
    nodata: '暂无数据',
    search: '搜索',
    tips: '*当前页展示内容为项目方自行填写，DEX不对此内容真实性负责',
    time: '发行时间',
    total: '发行总量',
    circulation: '代币流通量',
    price: '发行价',
  ...
  assets: {
    transfer_out: '转出到币币账户',
    transfer_in: '从币币账户转入',
    transfer_complete: '划转完成',
  },
