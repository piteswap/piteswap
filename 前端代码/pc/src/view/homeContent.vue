  ...
  <div style="width: 100%;" class="indexBlackes home-box mt45">
    <!-- <div>
      <swiper :options="swiperOption">
        <swiper-slide  v-for="slide in pics" style="background: #171c2b" :key="slide.pic" >
    ...
    <div>
      <pointwave :color="'#00e8b8'" :top="0" />
      <div class="banner-bg">
        <div class="banner-left">
          <p style="font-size: 4vmin;font-weight: bold">
            <span style="width: 20vmin">The Most </span>
            <span class="typer_main" style="display: block;">
              Trusted,secure,Fast,Reliable</span
            >
          </p>
          <p style="font-size: 4vmin;font-weight: bold">
            Cryptocurrency Exchange
          </p>
          <p>Get started with the easiest and most secure platform to buy,</p>
          <p>sell,trade,and earn cryptocuuencies</p>
          <div class="btn-bg" v-if="!address">
        ...
        <div class="banner-right">
          <img src="@/assets/images/nbkfnkf.png" alt="" />
        </div>
      </div>
      ...
      >
        <ul class="flex alcenter market_list">
          <li
            class="flex flex1 market_li around curPer"
            ...
            :key="index"
            v-if="item.currency_name"
          >
            <div
              :data-name="item.currency_name + '/' + item.legal_name"
              class="flex column"
              style="width: 100%; padding: 0 10px"
            >
              <div class="flex" style="align-items: center">
                <img :src="item.logo" alt="" class="list-logo">

                <div class="flex" style="flex: 1;align-items:center">
                  <span class="symbol blue ft12" style="color: #000;margin-right:10px"
                    >{{ item.currency_name }}/{{ item.legal_name }}</span
                  >
                  <span class="now_price nowPrice ft20" style="margin-right:10px">{{
                    parseFloat(item.now_price).toFixed(4)
                  }}</span>
                  <!-- <p class="ft16" style="padding: 0; white-space: nowrap">
                    <span>{{ $t("home.vol") }}</span>
                    <span> {{ item.volume | numFilters(4) }}</span>
                  </p> -->
                </div>

                <div>
                  <p
                    class="rateup greens ft16"
                    :class="item.change < 0 ? 'red' : ''"
    ...
    <div class="md">
      <div class="notice_box">
        <div class="notice_list" style="color: red; font-size: 25px;">
          <!-- 此为诺亚搭建演示平台，请勿充值，平台搭建维护专业定制，联系TG ：<a href="https://t.me/nuoyacode"> @CXY999</a> -->
        </div>
      </div>
      ...
      <div class="feature_wrap">
        <h2 v-html="$t('home.d1', { number: 536866236.36 })"></h2>
        <p>{{ $t("home.d2") }}</p>
        <ul
          slide-type="a-fadeinB"
          class="feature_list can_animate hide"
          style="height: 236px"
        >
          <li class="feature_safe">
            <div>
              <img src="@/assets/images/index11.svg" />
            </div>
          ...
          <li class="feature_eco">
            <div>
              <img src="@/assets/images/index22.svg" />
            </div>
            <p class="title">{{ $t("home.d5") }}</p>
            <p>{{ $t("home.d6") }} <br />{{ $t("home.d7") }}</p>
          </li>
          <li class="feature_user">
            <div>
              <img src="@/assets/images/index33.svg" />
            </div>
        ...
        <ul
          class="info-list"
          style="width: 88%; max-width: 1300px; display: flex"
        >
          <li>
            <div>
          ...
          <li>
            <div>
              <img src="@/assets/images/Bitcoin-Digital.png" alt="" />
            </div>
        ...
        <div class="wrap_in">
          <div class="flex" style="width: 1300px; height: 100%; margin: 0 auto">
            <div class="inner-wrap hide" style="text-align: left">
              <img
                src="@/assets/images/mobilephone.png"
                style="position: absolute"
              />
              <h2 :class="{ ft28: lang != 'en', ft16: lang == 'en' }">
                {{ $t("home.c12") }}
              </h2>
                ...
                <div class="mon_mind tc">
                  ...
                  <div class="down-dsp-wrap">
                    ...
                    <div>
                      ...
                      <div>
                        ...
                        <p>Speed experience, enjoy your ideas</p>
                      </div>
                    </div>
                  </div>
                  <div style="padding-top: 50px">
                    ...
                    >
                      ...
                      <el-button type="download" slot="reference"
                        >IOS App</el-button
                      >
                    </el-popover>
                    <el-popover
            ...
            >
              ...
              <div style="line-height: 60px; width: 100%; text-align: left">
                {{ $t("home.dsp50") }}
              </div>
            ...
            <div style="width: 600px; display: flex; align-items: center">
              <img style="width: 600px" src="@/assets/images/laa.png" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="register_wrap tc flex column center">
        <template v-if="address">
          ...
          <div class="flex alcenter mauto rebox">
            <img src="@/assets/images/kvmskedmv.png" alt="" />
            <img src="@/assets/images/nsvjesdnjvns.png" alt="" />
            <img src="@/assets/images/vkdmvksm.png" alt="" />
            <img src="@/assets/images/vmdxkms.png" alt="" />
          </div>
        </template>
        <template v-else>
          <h2>{{ $t("home.atrade") }}</h2>
          <div class="flex alcenter mauto rebox">
            <input
              type="text"
              v-model="username"
              :placeholder="$t('home.pinput')"
              class="input-register"
            />
            <button @click="toRegister" class="ft16">
              {{ $t("registers") }}
            </button>
          </div>
        </template>
...
export default {
  ...
  computed: {
    optionLeft() {
      return {
        direction: 2,
        limitMoveNum: this.quotationList.length
      };
    },
  },
  methods: {
      ...
      this.$http({
        ...
        .then((res) => {
          if (res.data.type == "ok") {
            ...
            console.log(that.quotationList, "99");
            // that.marketSocket();
          }
        })
        .catch((error) => {});
    ...
    getLunbo() {
      ...
      this.$http
        ...
        .then((res) => {
          if (res.data.type == "ok") {
            var pics = [];
            // console.log(res.data.message.list.length,'12111111111');
...
.banner-bg {
  ...
  .banner-left {
    ...
    .typer_main {
      animation: typer 6s steps(50, end) infinite;
